    ...
    <div class="cohort-detail-toolbar course-enrollment-detail-toolbar">
        ...
        <div class="cohort-detail-action-group">
            ...
            @elseif ($enrollment->status === 'active')
                @include('course-enrollments.partials.lifecycle-action', ['action' => route($routePrefix.'.suspend', $enrollment->id), 'triggerClass' => 'btn btn-secondary course-enrollment-bulk-action--suspend', 'triggerLabel' => __('lf.LF_course_enrollment_lifecycle_suspend'), 'title' => __('lf.LF_course_enrollment_lifecycle_suspend_title'), 'body' => __('lf.LF_course_enrollment_lifecycle_suspend_body'), 'confirmClass' => 'btn btn-primary', 'confirmLabel' => __('lf.LF_course_enrollment_lifecycle_suspend')])
