    ...
    <section class="admin-form-standard-section" aria-labelledby="learning-framework-identity">
        ...
        <div class="admin-form-field-grid">
            <div class="lf-form-group admin-form-field">
                ...
                <input id="code" name="code" class="lf-form-control" required maxlength="100" autocomplete="off" value="{{ old('code', $framework->code ?? '') }}">
            ...
            <div class="lf-form-group admin-form-field">
                ...
                <input id="name" name="name" class="lf-form-control" required maxlength="255" value="{{ old('name', $framework->name ?? '') }}">
            ...
            <div class="lf-form-group admin-form-field--full">
                ...
                <textarea id="description" name="description" class="lf-form-control" rows="4" maxlength="5000">{{ old('description', $framework->description ?? '') }}</textarea>
    ...
    <section class="admin-form-standard-section" aria-labelledby="learning-framework-scale">
        ...
        <div class="admin-form-field-grid">
            <div class="lf-form-group admin-form-field">
                ...
                <input id="mastery_scale_key" name="mastery_scale_key" class="lf-form-control" required maxlength="100" value="{{ old('mastery_scale_key', $framework->default_mastery_scale_key ?? 'lf-default') }}">
            ...
            <div class="lf-form-group admin-form-field">
                ...
                <input id="mastery_scale_version" name="mastery_scale_version" class="lf-form-control" required maxlength="50" value="{{ old('mastery_scale_version', $framework->default_mastery_scale_version ?? '1') }}">
