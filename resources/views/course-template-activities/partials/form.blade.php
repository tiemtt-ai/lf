...
<div class="course-template-activity-form"
    ...
    <div class="lf-form-group"><x-form-label for="estimated_duration_minutes" :value="__('lf.LF_course_template_activity_common_estimated_duration_minutes')" /><input id="estimated_duration_minutes" type="number" min="1" step="1" name="estimated_duration_minutes" class="lf-form-control" value="{{ old('estimated_duration_minutes', $storedEstimateMinutes) }}" placeholder="{{ __('lf.LF_course_template_activity_placeholder_estimated_duration') }}"><p class="lf-form-help">{{ __('lf.LF_course_template_activity_common_estimated_duration_help') }}</p></div>
