...
<div class="course-template-activity-form"
    ...
    <div class="lf-form-group" x-show="activityType === 'video'" x-cloak>
        ...
        <input id="activity_video_file" type="file" name="activity_video_file" class="lf-form-control" accept="video/*">
    ...
    <div class="lf-form-group" x-show="activityType === 'audio'" x-cloak>
        ...
        <input id="activity_audio_file" type="file" name="activity_audio_file" class="lf-form-control" accept="audio/*">
    ...
    <div class="lf-form-group" x-show="activityType === 'document'" x-cloak>
        ...
        <input id="activity_document_file" type="file" name="activity_document_file" class="lf-form-control" accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.txt,application/pdf">
