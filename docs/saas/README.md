...
| Usage | [LF-SaaS-Usage](LF-SaaS-Usage.md) | Foundation Approved and Frozen — Version 1.0; Usage measurement, counters and summaries |
| Billing | [LF-SaaS-Billing](LF-SaaS-Billing.md) | Foundation Approved and Frozen — Version 1.0; Invoice, Payment and Credit Note |
