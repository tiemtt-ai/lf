...
| R3 | Media Read Contract v1.8 có scoped runtime/test và remediation evidence, nhưng A–H record do cùng implementation stream lập; chưa có independent reviewer | **Open** — chặn việc coi Spec B là architecture-approved và chặn real AI consumer rollout |
