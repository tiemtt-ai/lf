...
| Learning | [LF-Core-Learning](LF-Core-Learning.md) Version 1.1 | [ADR-0016](../adr/ADR-0016-Learning-Foundation.md) (Frozen) | [learning/](../database/learning/) — Phase 3 Frozen; migration Not Implemented |
