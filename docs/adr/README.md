...
| [ADR-0020](ADR-0020-AI-Vision-Interpretation-Boundary.md) | Diễn giải biểu đồ/sơ đồ/ảnh: neo trích dẫn, model run bắt buộc, quota chặn trước, retention theo ADR-0018 | Approved |
