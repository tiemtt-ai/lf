...
| SaaS Commercial (Plan, Subscription, Entitlement, Reservation) | SaaS × Commercial | [ADR-0008](adr/ADR-0008-SaaS-Commercial-Foundation.md) (v1.1 candidate) | [saas/LF-SaaS-Commercial.md](saas/LF-SaaS-Commercial.md) | [database/saas-commercial/README.md](database/saas-commercial/README.md), [saas_usage_reservations](database/saas-commercial/saas_usage_reservations.md) — **Review, chưa migration** | AI provider gate implementation review; cần independent schema review | — | Guardrails → ADR-0008 → Commercial/Usage docs → database packet → independent review → Freeze → migration |
