...
| SaaS Commercial (Plan, Subscription, Entitlement, Reservation) | SaaS × Commercial | [ADR-0008](adr/ADR-0008-SaaS-Commercial-Foundation.md) v1.1 Frozen | [saas/LF-SaaS-Commercial.md](saas/LF-SaaS-Commercial.md) | [database/saas-commercial/README.md](database/saas-commercial/README.md), [saas_usage_reservations](database/saas-commercial/saas_usage_reservations.md) — **Review, chưa migration**; freeze 2026-09-10 đã rút vì đặt trước independent review PASS | AI provider gate implementation review; independent Architecture Review PASS vẫn là migration gate | — | Guardrails → ADR-0008 → Commercial/Usage docs → Frozen packet → independent review PASS → migration |
| SaaS Usage (Counter, Event, Summary) | SaaS × Usage | [ADR-0009](adr/ADR-0009-SaaS-Usage-Foundation.md) (Frozen) | [saas/LF-SaaS-Usage.md](saas/LF-SaaS-Usage.md) | [database/saas-usage/README.md](database/saas-usage/README.md), [saas_usage_events](database/saas-usage/saas_usage_events.md), [saas_usage_counters](database/saas-usage/saas_usage_counters.md) — **Review, chưa migration**; freeze 2026-09-10 đã rút vì đặt trước independent review PASS | AI provider gate implementation review; schema đã sửa theo finding E1/E2/E3/C1 và P2-2…P2-6, independent review PASS vẫn là migration gate | — | Guardrails → ADR-0009 → saas/LF-SaaS-Usage.md → database/saas-usage/README.md (lưu ý chưa triển khai) |
