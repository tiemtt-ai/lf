...
| [saas/LF-SaaS-Commercial.md](saas/LF-SaaS-Commercial.md) | Foundation Frozen — Version 1.1 candidate; Plan, Subscription, Entitlement and Commercial reservation architecture |
...
| [ADR-0020](adr/ADR-0020-AI-Vision-Interpretation-Boundary.md) | Approved: diễn giải là output AI không phải row media_*; mỗi call một ai_model_runs; quota chặn trước; retention thừa kế ADR-0018 |
...
| [quality/LF-AI-Vision-Interpretation-Implementation-Review.md](quality/LF-AI-Vision-Interpretation-Implementation-Review.md) | Bước 6 Vision Interpretation, packet schema: migration `ai_vision_interpretations` dưới Owner waiver, kiểm trên MariaDB 11.4.12 và 10.4.21, hai lỗi bắt tại Gate Migration (slot không đơn ánh, CHECK bbox UNKNOWN); service backend, nối xoá Media qua `MediaFileDeleted` + đối soát; Owner chốt nghiệm thu backend 2026-09-14 (không phải review PASS) |
| [quality/LF-SaaS-Commercial-Usage-Packet-Reviewer-Brief.md](quality/LF-SaaS-Commercial-Usage-Packet-Reviewer-Brief.md) | Brief giao reviewer độc lập kiểm packet bốn bảng SaaS Commercial/Usage để mở chặn migration: phạm vi, ràng buộc độc lập, 11 câu hỏi bắt buộc, lệnh kiểm chứng trên MariaDB 11.4 và những gì không được tính là PASS |
...
* adr/ADR-0020-AI-Vision-Interpretation-Boundary.md
* platform/LF-Media.md
...
| SaaS Commercial (Plan, Subscription, Entitlement, Reservation) | SaaS × Commercial | [ADR-0008](adr/ADR-0008-SaaS-Commercial-Foundation.md) v1.1 Frozen | [saas/LF-SaaS-Commercial.md](saas/LF-SaaS-Commercial.md) | [database/saas-commercial/README.md](database/saas-commercial/README.md), [saas_usage_reservations](database/saas-commercial/saas_usage_reservations.md) — quota packet Frozen; migration 2026-09-12, verified on isolated MariaDB 11.4 | Owner waived mandatory independent review for Step 4; real store and two-connection tests implemented | — | Guardrails → ADR-0008 → Commercial/Usage docs → Owner-approved packet → migration/tests |
| SaaS Usage (Counter, Event, Summary) | SaaS × Usage | [ADR-0009](adr/ADR-0009-SaaS-Usage-Foundation.md) (Frozen) | [saas/LF-SaaS-Usage.md](saas/LF-SaaS-Usage.md) | [database/saas-usage/README.md](database/saas-usage/README.md), [saas_usage_events](database/saas-usage/saas_usage_events.md), [saas_usage_counters](database/saas-usage/saas_usage_counters.md) — Event/Counter schema implemented; other Usage tables remain deferred | Step 4 packet verified on isolated MariaDB 11.4; production apply is separate | — | Guardrails → ADR-0009 → Usage docs → Owner-approved packet → migration/tests |
...
| Media Storage & Delivery | Platform/Media | [ADR-0004](adr/ADR-0004-Media-Foundation.md) (S3 Storage Decision), [ADR-0018](adr/ADR-0018-Media-PII-And-External-Processing-Boundary.md) (PII và external-processing boundary), [ADR-0019](adr/ADR-0019-Media-Structured-Extraction-Boundary.md) (structured extraction; v1.8 mở language evidence đa trị và ngưỡng formula) | [platform/LF-Media.md](platform/LF-Media.md), [platform/LF-Media-Processing-Contract.md](platform/LF-Media-Processing-Contract.md), [platform/LF-Media-Read-Contract.md](platform/LF-Media-Read-Contract.md) | [media_files.md](database/media/media_files.md), [media_variants.md](database/media/media_variants.md), [media_processing_jobs.md](database/media/media_processing_jobs.md), [media_processing_job_locales.md](database/media/media_processing_job_locales.md), [media_extracted_texts.md](database/media/media_extracted_texts.md), [media_extracted_regions.md](database/media/media_extracted_regions.md), [media_region_languages.md](database/media/media_region_languages.md), [media_extracted_tables.md](database/media/media_extracted_tables.md), [media_table_cells.md](database/media/media_table_cells.md), [media_extracted_formulas.md](database/media/media_extracted_formulas.md), [media_transcripts.md](database/media/media_transcripts.md), [media_captions.md](database/media/media_captions.md), [media_access_logs.md](database/media/media_access_logs.md) | [Media Processing Substrate Review](quality/LF-Media-Processing-Substrate-Architecture-Review.md) (Approved với implementation risk đã ghi), [Media Structured Extraction Review](quality/LF-Media-Structured-Extraction-Architecture-Review.md) (Gate M PASS, Runtime Gate R chưa), [Media Read Contract Review](quality/LF-Media-Read-Contract-Architecture-Review.md) (independent review đang chờ), [Document Processing Final Code Review](quality/LF-Document-Processing-Final-Code-Review.md) (Document local, không suy rộng sang Audio/Video hay production) | tech/LF-Tech-AWS.md | Guardrails → ADR-0004 → ADR-0018/ADR-0019 → Media contracts → database docs → review chuyên biệt → tech/LF-Tech-AWS.md |
