...
| [quality/LF-AI-Embedding-Qdrant-Implementation-Review.md](quality/LF-AI-Embedding-Qdrant-Implementation-Review.md) | Bước 5 Embedding/Qdrant: vòng đời `ai_embeddings` đứng sau gate, xoá điểm vector chỉ khi có acknowledgment, hậu kiểm truy hồi vào lại authorization Media; OD-1 đã chốt (`failed → pending`), OD-2 audit truy hồi và OD-3 định danh bị ghim vẫn mở |
