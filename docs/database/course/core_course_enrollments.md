...
Document Path: database/course/core_course_enrollments.md
...
Teacher Judgment source. Migration, physical contract and development
deployment passed; production remains separately gated by the
